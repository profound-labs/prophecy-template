...
%
% https://github.com/profound-labs/prophecy-template
%
% https://profound-labs.github.io/prophecy-template/
%
...
bottom is better. When it causes large streches, it is better to put in a
=\clearpage= manually.

*NOTE:* Use the =bottom= footmisc option when using =\raggedbottom=.

*NOTE:* Using =\raggedbottom= here as a default. It helps with quotes when the
pages frequently have to break early anyway.
...
\newcommand\partTitleFont\crimsonRomanFont

\newcommand\chapterNameFont\crimsonRomanFont
\newcommand\chapterTitleFont\crimsonRomanFont
\newcommand\chapterNumberFont\crimsonRomanFont
\newcommand\chapterAuthorFont\crimsonRomanFont
\newcommand\chapterNoteFont\crimsonRomanFont

\newcommand\sectionFont\crimsonRomanFont

% quote

\newcommand\sideruleQuoteFont\crimsonRomanFont
...
* Font Sizes
** Main Font Size and Indentations
...
\setlength{\BOOK@paperHeight}{9in}
\setlength{\BOOK@paperWidth}{6in}
...
{\addvspace{25pt}%
\fontsize{11}{11}\crimsonRomanFont\selectfont}%
{%
  \contentsmargin{0pt}%
...
\makechapterstyle{lowtitle-frontmatter}{
...
\makechapterstyle{lowtitle-appendix}{
  \chapterstyle{lowtitle-frontmatter}
}
  
\makechapterstyle{lowtitle-backmatter}{
  \chapterstyle{lowtitle-frontmatter}
}
#+end_src
...
: ../styles/prophecy-chapter-bellatrix.tex

#+begin_src tex :tangle ../styles/prophecy-chapter-bellatrix.tex
...
: ../styles/prophecy-chapter-mintaka.tex 

#+begin_src tex :tangle ../styles/prophecy-chapter-mintaka.tex
...
: ../styles/prophecy-chapter-shedir.tex

#+begin_src tex :tangle ../styles/prophecy-chapter-shedir.tex
...
: ../styles/prophecy-chapter-caph.tex

#+begin_src tex :tangle ../styles/prophecy-chapter-caph.tex
% === Caph ===
%
...
: ../styles/prophecy-chapter-mirzam.tex

#+begin_src tex ../styles/prophecy-chapter-mirzam.tex
\newif\ifchaptertitleleft
\chaptertitleleftfalse

\makechapterstyle{mirzam}{
  \chapterstyle{lowtitle}
  \def\setchapterspaces{%
  ...
  \renewcommand*\printchaptertitle[1]{%
    ...
    \if@mainmatter
      ...
      \vspace*{\midchapskip}%
      {\centering%
        \includegraphics[width=0.9\linewidth]{mark-crop}%
      \par}%
    \fi
  }
}
...
\newcommand\frontmatterChapterStyle{\chapterstyle{lowtitle-frontmatter}}
\newcommand\mainmatterChapterStyle{\chapterstyle{lowtitle}}
\newcommand\appendixChapterStyle{\chapterstyle{lowtitle-appendix}}
\newcommand\backmatterChapterStyle{\chapterstyle{lowtitle-backmatter}}
...
*NOTE:* Set =\footnotemargin= to =\quoteMargin= if you want the quote margin to
align with. Using a fixed value here.
...
#+begin_src tex
\DefineFNsymbols{prophecy}{*{**}{***}}
\setfnsymbol{prophecy}
#+end_src
